...
namespace RcClientPhp\Client\Interceptor;
...
use \RcClientPhp\Client\Interceptor\KeyHandler;
use \RcClientPhp\Client\Interceptor\MyLogger;
use \RcClientPhp\Client\Model\Errors;
use \RcClientPhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\RcClientPhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \RcClientPhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \RcClientPhp\Client\Model\Errores(["errors" => [$error]]);
