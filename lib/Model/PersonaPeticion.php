...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'curp' => 'string',
        'nacionalidad' => 'string',
        'residencia' => '\RcClientPhp\Client\Model\CatalogoResidencia',
        'estado_civil' => '\RcClientPhp\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\RcClientPhp\Client\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\RcClientPhp\Client\Model\DomicilioPeticion'
    ];
