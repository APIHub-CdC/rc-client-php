...
class Respuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'persona' => '\RcClientPhp\Client\Model\PersonasRespuesta',
        'consultas' => '\RcClientPhp\Client\Model\Consulta[]',
        'creditos' => '\RcClientPhp\Client\Model\Credito[]',
        'domicilios' => '\RcClientPhp\Client\Model\DomicilioRespuesta[]',
        'empleos' => '\RcClientPhp\Client\Model\Empleo[]',
        'mensajes' => '\RcClientPhp\Client\Model\Mensaje[]'
    ];
