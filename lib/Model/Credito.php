...
namespace RcClientPhp\Client\Model;
...
class Credito implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'tipo_responsabilidad' => '\RcClientPhp\Client\Model\CatalogoTipoResponsabilidad',
        'tipo_cuenta' => '\RcClientPhp\Client\Model\CatalogoTipoCuenta',
        'tipo_credito' => '\RcClientPhp\Client\Model\CatalogoTipoCredito',
        'clave_unidad_monetaria' => '\RcClientPhp\Client\Model\CatalogoMoneda',
        'valor_activo_valuacion' => 'int',
        'numero_pagos' => 'int',
        'frecuencia_pagos' => '\RcClientPhp\Client\Model\CatalogoFrecuenciaPago',
        'monto_pagar' => 'float',
        ...
        'clave_prevencion' => '\RcClientPhp\Client\Model\CatalogoPrevencion',
        ...
        'id_domicilio' => 'string',
        'servicios' => 'string',
        'can' => '\RcClientPhp\Client\Model\CAN'
    ];
