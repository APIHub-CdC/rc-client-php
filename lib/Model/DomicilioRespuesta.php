...
class DomicilioRespuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\RcClientPhp\Client\Model\CatalogoEstados',
        'cp' => 'int',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\RcClientPhp\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\RcClientPhp\Client\Model\CatalogoTipoAsentamiento',
